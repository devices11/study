...
public class base {
    ...
    public static int[] swapMinMax() {
        ...
        // поиск индекса минимального и максимального числа в массиве  , ПОПРАВИТЬ Массив размерностью 20, заполняется случайными целыми числами от -10 до 10. Найти максимальный отрицательный и МИНИМАЛЬНЫЙ положительный элементы массива. Поменять их местами.
        int array_min = 0;
        int array_max = 0;
        for (int j = 1; j < 20; j++) {
